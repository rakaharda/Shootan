#ifndef GSMULTIPLAYER_H
#define GSMULTIPLAYER_H
...
class GSMultiplayer : public GameState, public Collision
{
public:
    GSMultiplayer(VideoSettings *_videoSettings);
    virtual ~GSMultiplayer();
    GameStates update();
    void draw();
