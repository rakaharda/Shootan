...
GSMultiplayer::GSMultiplayer(VideoSettings *_videoSettings) :
    player(new Player),
    fieldSize(sf::IntRect(0, 0, 2880, 1620)),
...
GameStates GSMultiplayer::update()
{
...
void GSMultiplayer::updateBackground()
{
    sf::Color color;
...
void GSMultiplayer::updateEntities()
{
    player->update();
...
/*
void GSMultiplayer::updateFactories()
{
    enemyFactory->update();
} */

void GSMultiplayer::updateMusic()
{
...
void GSMultiplayer::updateStats()
{
...
void GSMultiplayer::collectTrash()
{
    for(unsigned int i = 0; i<vecProjectiles.size(); i++)
    {
...
void GSMultiplayer::checkProjectiles()
{
    for(unsigned int i = 0; i < vecProjectiles.size(); i++)
    {
        /*
...
void GSMultiplayer::checkPerkMenu()
{
...
void GSMultiplayer::checkDestroyers()
{
    /*
    for(unsigned int i = 0; i < vecEnemies.size(); i++)
        {
...
void GSMultiplayer::loadResources()
{
    //*Fonts
